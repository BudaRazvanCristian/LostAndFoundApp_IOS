...
const LostItemsScreen: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(async () => {
      try {
        ...
        console.error("Lost search error:", searchError);
        if (isActive) {
          setSearchItems([]);
        }
      } finally {
  ...
  const filteredLostItems = hasActiveFilters ? searchItems : lostItems;
      ...
      <View style={styles.container}>
        ...
        <View style={layout === "vertical" ? styles.card : styles.cardHorizontal}>
          ...
          <Text style={styles.sectionText}>
            Search by title (for example "mouse") and by lost date.
          </Text>
          ...
          {isLoading || isSearching ? (
            <View style={styles.feedbackWrap}>
              ...
              <Text style={styles.feedbackText}>
                {isSearching ? "Searching lost items..." : "Loading lost items..."}
              </Text>
            </View>
          ) : error ? (
            <View style={styles.feedbackWrap}>
